...
const Paciente = ({ paciente, setPaciente, eliminarPaciente }) => {
    ...
    const handleEliminar = () =>{
        const respuesta =  confirm('Deseaas eliminar este paciente?');
    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-lg">
            ...
            <div className="flex gap-2 mt-10">
                <button
                    type="button"
                    className="py-2 px-10 bg-violet-600 hover:bg-violet-700 text-white font-bold uppercase rounded-md"
